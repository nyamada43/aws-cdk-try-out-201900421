...
export class CdkDemo01Stack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    // const codebuildEc2Role = new Role(this, `${deployEnv}-coodebuild`,{
    //   assumedBy: new ServicePrincipal('codebuild.amazonaws.com')
    // })

    // codebuildEc2Role.node.applyAspect(new cdk.Tag("env", `${deployEnv}`))
    ...
    // const codebuildPolicy = new Policy(this, `${appName}-ElasticIP-Policy`,{
    //   statements: [asgEc2PolicyStatement],
    // })
    ...
    //   deploymentConfig: new codedeploy.ServerDeploymentConfig.ALL_AT_ONCE,
    //   role: codeDeployRole,
    //   installAgent: true,
